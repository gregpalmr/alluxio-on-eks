...
Use the git command to clone this repo (or download the zip file from the github.com site).
     ...
     git clone https://github.com/gregpalmr/alluxio-on-eks
...
### Step 6. Deploy Trino on the EKS cluster

TBD

### Step 7. Run Trino queries against Alluxio 

TBD

### Step 8. Destroy the EKS cluster
